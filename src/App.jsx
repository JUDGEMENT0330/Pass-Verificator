      ...
      <div className="container">
        <header className="header">
          ...
          <div className="powered-by">
            Powered by <span className="brand-name">Cybervaltorix</span>
          </div>
        </header>
        ...
        <footer className="footer">
          ...
          <p className="footer-brand">
            Desarrollado por <a href="https://cybervaltorix.com" target="_blank" rel="noopener noreferrer" className="brand-link">
              <strong>Cybervaltorix</strong>
            </a> - Soluciones de Ciberseguridad
          </p>
        </footer>
      </div>
    </div>
